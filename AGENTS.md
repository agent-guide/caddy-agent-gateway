...
- `pkg/gateway/` — runtime route/VirtualKey/provider resolution (`AgentGateway`) and the route-model packages (`llmroute`, `modelcatalog`, `mcproute`, `acproute`, `builtinroute`, `virtualkey`) → `pkg/gateway/AGENTS.md`
