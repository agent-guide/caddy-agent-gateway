...
func llmUsageEventsDDL(table string) string {
	return `CREATE TABLE IF NOT EXISTS ` + table + ` (
		...
		response_mode TEXT, relay_ineligible_reason TEXT, message_id_source TEXT, usage_source TEXT, execution TEXT,
...
func MigrateUsageTables(db *gorm.DB) error {
	...
	additive := []struct {
		...
		{"llm_usage_events", "response_mode TEXT"},
		{"llm_usage_events", "relay_ineligible_reason TEXT"},
		{"llm_usage_events", "message_id_source TEXT"},
		{"llm_usage_events", "usage_source TEXT"},
		{"llm_usage_events", "execution TEXT"},
